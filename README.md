...
- 🔬 Currently collaborating on DARE-DQ, an AI research project in offline reinforcement learning. We're developing a novel metric that scores trajectories based on both cumulative reward and empirical state density to promote effective and well-supported policies.
